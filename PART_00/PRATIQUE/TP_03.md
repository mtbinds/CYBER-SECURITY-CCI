...
1. **Utiliser Telnet pour se connecter à un serveur SMTP** :
   ...
   - Suivez ces étapes pour envoyer un e-mail :
     ...
     QUIT
     ```
   - Vous pouvez utiliser ***Papercut SMTP*** en suivant [ce lien](https://github.com/ChangemakerStudios/Papercut-SMTP) ou ***Mailwhale*** en suivant [ce lien](https://github.com/muety/mailwhale).  
